...
- **Retorno de Consola:** [Qué debe imprimir el script al finalizar: JSON, ruta o mensaje de éxito].
...
## 5. Restricciones y Casos Límite
*Condiciones conocidas que podrían romper el flujo estándar.*
- **Límite de uso:** [Ej: "La API solo permite 5 llamadas por minuto"].
- **Formatos:** [Ej: "Si el campo contiene caracteres especiales, el script debe sanitizarlos primero"].
...
|-------|-----------------|------------|-------------------|
| [DD/MM] | [Tipo de error] | [Por qué falló] | [Instrucción: "Usar método X en lugar de Y"] |
| ... | ... | ... | ... |

> **Nota:** Si encuentras un nuevo error, **primero** arréglalo en el script, y **luego** documenta la regla aquí para evitar regresiones futuras.
...
## 8. Lista de Verificación Pre-Ejecución
- [ ] Variables de entorno configuradas en `.env`
- [ ] Dependencias instaladas (`pip install -r requirements.txt`)
- [ ] Archivos de entrada disponibles y validados
- [ ] Permisos necesarios otorgados (API, archivos, etc.)

## 9. Lista de Verificación Post-Ejecución
- [ ] Salidas generadas correctamente
- [ ] Registros revisados para errores o advertencias
- [ ] Resultados validados contra los criterios esperados
- [ ] Directiva actualizada con nuevos aprendizajes (si aplica)

## 10. Notas Adicionales
Cualquier contexto que no encaje en las secciones anteriores.

[Espacio para decisiones de diseño, referencias a documentación externa o advertencias de seguridad].
